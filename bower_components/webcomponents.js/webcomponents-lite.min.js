...
window.WebComponents = window.WebComponents || {}, function (e) {
    var t = e.flags || {}, n = "webcomponents.js", o = document.querySelector('script[src*="' + n + '"]');
    if (!t.noOpts) {
        if (location.search.slice(1).split("&").forEach(function (e) {
                e = e.split("="), e[0] && (t[e[0]] = e[1] || !0)
            }), o)for (var r, i = 0; r = o.attributes[i]; i++)"src" !== r.name && (t[r.name] = r.value || !0);
        if (t.log) {
            var a = t.log.split(",");
        ...
        enqueue: function (e) {
            ...
            switch (e.stopImmediatePropagation(), e.type) {
                case"DOMAttrModified":
                    var t = e.attrName, n = e.relatedNode.namespaceURI, o = e.target, r = new c("attributes", o);
                ...
                case"DOMCharacterDataModified":
                    var o = e.target, r = c("characterData", o), a = e.prevValue;
                    i(o, function (e) {
                ...
                case"DOMNodeInserted":
                    ...
                    var m = f.previousSibling, p = f.nextSibling, r = c("childList", e.target.parentNode);
                    r.addedNodes = s, r.removedNodes = d, r.previousSibling = m, r.nextSibling = p, i(e.relatedNode, function (e) {
...
}(), window.HTMLImports = window.HTMLImports || {flags: {}}, function (e) {
    function t(e, t) {
        t = t || p, o(function () {
            i(e, t)
        }, t)
    ...
    function o(e, t) {
        if (n(t))e && e(); else {
            var r = function () {
                ("complete" === t.readyState || t.readyState === g) && (t.removeEventListener(b, r), o(e, t))
            };
            t.addEventListener(b, r)
        }
    }
    ...
    function i(e, t) {
        ...
        if (d)for (var c, u = 0; d > u && (c = i[u]); u++)a(c) ? o.call(c, {target: c}) : (c.addEventListener("load", o), c.addEventListener("error", o)); else n()
    }
    ...
    function s(e) {
        for (var t, n = 0, o = e.length; o > n && (t = e[n]); n++)d(t) && c(t)
    }
    ...
    var v = /Trident|Edge/.test(navigator.userAgent), g = v ? "complete" : "interactive", b = "readystatechange";
    l && (new MutationObserver(function (e) {
        ...
        if ("loading" === document.readyState)for (var e, t = document.querySelectorAll("link[rel=import]"), n = 0, o = t.length; o > n && (e = t[n]); n++)c(e)
    }()), t(function () {
        HTMLImports.ready = !0, HTMLImports.readyTime = (new Date).getTime();
        var e = p.createEvent("CustomEvent");
        e.initCustomEvent("HTMLImportsLoaded", !0, !0, {}), p.dispatchEvent(e)
    ...
    var t = /(url\()([^)]*)(\))/g, n = /(@import[\s]+(?!url\())([^;]*)(;)/g, o = {
        ...
        }, resolveUrlsInCssText: function (e, o) {
            var r = this.replaceUrls(e, o, t);
            return r = this.replaceUrls(r, o, n)
        }, replaceUrls: function (e, t, n) {
            return e.replace(n, function (e, n, o, r) {
                var i = o.replace(/["']/g, "");
                return t.href = i, i = t.href, n + "'" + i + "'" + r
            })
        }
    };
    e.path = o
    ...
    o.prototype = {
        addNodes: function (e) {
            ...
            this.cache[e] = o;
            for (var i, a = this.pending[e], s = 0, d = a.length; d > s && (i = a[s]); s++)this.onload(e, i, o, n, r), this.tail();
            this.pending[e] = null
        }, tail: function () {
    ...
    var a = e.path, s = e.rootDocument, d = e.flags, c = e.isIE, u = e.IMPORT_LINK_TYPE, l = "link[rel=" + u + "]", f = {
        ...
        trackElement: function (e, t) {
            var n = this, o = function (o) {
                t && t(o), n.markParsingComplete(e), n.parseNext()
            };
            if (e.addEventListener("load", o), e.addEventListener("error", o), c && "style" === e.localName) {
                var r = !1;
                if (-1 == e.textContent.indexOf("@import"))r = !0; else if (e.sheet) {
                    r = !0;
                    for (var i, a = e.sheet.cssRules, s = a ? a.length : 0, d = 0; s > d && (i = a[d]); d++)i.type === CSSRule.IMPORT_RULE && (r = r && Boolean(i.styleSheet))
                }
                r && e.dispatchEvent(new CustomEvent("load", {bubbles: !1}))
            }
        },
        parseScript: function (t) {
            var o = document.createElement("script");
            o.__importElement = t, o.src = t.src ? t.src : n(t), e.currentScript = t, this.trackElement(o, function () {
                o.parentNode.removeChild(o), e.currentScript = null
        ...
        nextToParseInDoc: function (e, n) {
            if (e && this._mayParse.indexOf(e) < 0) {
                ...
                for (var o, r = e.querySelectorAll(this.parseSelectorsForNode(e)), i = 0, a = r.length; a > i && (o = r[i]); i++)if (!this.isParsed(o))return this.hasResource(o) ? t(o) ? this.nextToParseInDoc(o["import"], o) : o : void 0
            }
            return n
        },
    ...
    var i = e.flags, a = e.IMPORT_LINK_TYPE, s = e.IMPORT_SELECTOR, d = e.rootDocument, c = e.Loader, u = e.Observer, l = e.parser, f = {
        documents: {},
        ...
        loaded: function (e, n, o, a, s) {
            if (i.load && console.log("loaded", e, n), n.__resource = o, n.__error = a, t(n)) {
                ...
                void 0 === d && (d = a ? null : r(o, s || e), d && (d.__importLink = n, this.bootDocument(d)), this.documents[e] = d), n["import"] = d
            }
            l.parseNext()
        },
    ...
    }, m = new c(f.loaded.bind(f), f.loadedAll.bind(f));
    if (f.observer = new u, !document.baseURI) {
        var p = {
            get: function () {
    ...
    e.importer = f, e.importLoader = m
}), HTMLImports.addModule(function (e) {
    var t = e.parser, n = e.importer, o = {
        added: function (e) {
            for (var o, r, i, a, s = 0, d = e.length; d > s && (a = e[s]); s++)o || (o = a.ownerDocument, r = t.isParsed(o)), i = this.shouldLoadNode(a), i && n.loadNode(a), this.shouldParseNode(a) && r && t.parseDynamic(a, i)
    ...
    var n = e.initializeModules, o = e.isIE;
    if (!e.useNative) {
    ...
    e.addModule = o, e.initializeModules = r, e.hasNative = Boolean(document.registerElement), e.useNative = !t.register && e.hasNative && !window.ShadowDOMPolyfill && (!window.HTMLImports || HTMLImports.useNative)
    ...
    function i(e, t) {
        if (e = wrap(e), !(a.indexOf(e) >= 0)) {
            a.push(e);
            for (var n, o = e.querySelectorAll("link[rel=" + s + "]"), r = 0, d = o.length; d > r && (n = o[r]); r++)n["import"] && i(n["import"], t);
            t(e)
        }
    }
    ...
    function a() {
        L = !1;
        for (var e, t = M, n = 0, o = t.length; o > n && (e = t[n]); n++)e();
        M = []
    }
    ...
    }), e.watchShadow = m, e.upgradeDocumentTree = b, e.upgradeSubtree = o, e.upgradeAll = t, e.attachedNode = r, e.takeRecords = h
}), CustomElements.addModule(function (e) {
    function t(t) {
        if (!t.__upgraded__ && t.nodeType === Node.ELEMENT_NODE) {
            var o = t.getAttribute("is"), r = e.getRegisteredDefinition(o || t.localName);
            if (r) {
                if (o && r.tag == t.localName)return n(t, r);
                if (!o && !r["extends"])return n(t, r)
            }
        }
    }

    function n(t, n) {
        return a.upgrade && console.group("upgrade:", t.localName), n.is && t.setAttribute("is", n.is), o(t, n), t.__upgraded__ = !0, i(t), e.attachedNode(t), e.upgradeSubtree(t), a.upgrade && console.groupEnd(), t
    }
    ...
    function s(e) {
        if (!Object.__proto__) {
            ...
            if (e.is) {
                var n = document.createElement(e.tag), o = Object.getPrototypeOf(n);
                o === e.prototype && (t = o)
            }
            for (var r, i = e.prototype; i && i !== t;)r = Object.getPrototypeOf(i), i.__proto__ = r, i = r;
            e["native"] = t
        }
    }
    ...
    function m(e, t) {
        ...
        var o;
        return t ? (o = m(e), o.setAttribute("is", t), o) : (o = M(e), e.indexOf("-") >= 0 && w(o, HTMLElement), o)
    }
    ...
    HTMLTemplateElement = function () {
        ...
        for (var n, o = t.querySelectorAll(e), r = 0, i = o.length; i > r && (n = o[r]); r++)HTMLTemplateElement.decorate(n)
