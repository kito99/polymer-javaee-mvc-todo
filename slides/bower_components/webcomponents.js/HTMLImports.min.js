...
"undefined" == typeof WeakMap && !function () {
    ...
    function r(e, t) {
        if (n(t))e && e(); else {
            var o = function () {
                ("complete" === t.readyState || t.readyState === g) && (t.removeEventListener(_, o), r(e, t))
            };
    ...
    function i(e, t) {
        ...
        if (c)for (var d, l = 0; c > l && (d = i[l]); l++)a(d) ? r.call(d, {target: d}) : (d.addEventListener("load", r), d.addEventListener("error", r)); else n()
    }
    ...
    var l = "import", u = Boolean(l in document.createElement("link")), m = Boolean(window.ShadowDOMPolyfill), p = function (e) {
        return m ? ShadowDOMPolyfill.wrapIfNeeded(e) : e
    }, h = p(document), f = {
        get: function () {
    ...
    Object.defineProperty(document, "_currentScript", f), Object.defineProperty(h, "_currentScript", f);
    var v = /Trident|Edge/.test(navigator.userAgent), g = v ? "complete" : "interactive", _ = "readystatechange";
    ...
    }), e.IMPORT_LINK_TYPE = l, e.useNative = u, e.rootDocument = h, e.whenReady = t, e.isIE = v
    ...
    var a = e.path, s = e.rootDocument, c = e.flags, d = e.isIE, l = e.IMPORT_LINK_TYPE, u = "link[rel=" + l + "]", m = {
        documentSelectors: u,
    ...
    e.parser = m, e.IMPORT_SELECTOR = u
}), HTMLImports.addModule(function (e) {
    function t(e) {
        return n(e, a)
    }
    ...
    var i = e.flags, a = e.IMPORT_LINK_TYPE, s = e.IMPORT_SELECTOR, c = e.rootDocument, d = e.Loader, l = e.Observer, u = e.parser, m = {
        documents: {},
    ...
    }, p = new d(m.loaded.bind(m), m.loadedAll.bind(m));
    if (m.observer = new l, !document.baseURI) {
        var h = {
            get: function () {
